...
{
	Matrix X;
	X.e[0] = 2.0/(right-left); X.e[4] = 0.0f;             X.e[ 8] = 0.0f;           X.e[12] = -(right+left)/(right-left);
	X.e[1] = 0.0f;             X.e[5] = 2.0/(top-bottom); X.e[ 9] = 0.0f;           X.e[13] = -(top+bottom)/(top-bottom);
	X.e[2] = 0.0f;             X.e[6] = 0.0f;             X.e[10] = 2.0/(far-near); X.e[14] = -(far+near)/(far-near);
	X.e[3] = 0.0f;             X.e[7] = 0.0f;             X.e[11] = 0.0f;           X.e[15] = 1.0f;
